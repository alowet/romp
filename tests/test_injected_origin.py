...
km = SourceFileLoader("romp_kernel_injected", os.path.join(BIN, "romp-kernel")).load_module()
sb = SourceFileLoader("romp_sdk_backend_injected", os.path.join(BIN, "romp_sdk_backend.py")).load_module()
jd = km.jd
